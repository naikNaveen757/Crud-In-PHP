    ...
    
{
    ...
    $query="SELECT DATE_FORMAT(dob, '%b-%d-%Y')dob,regno,studname,course,gender,phoneno,addr from student_info";
    $data=mysqli_query($conn,$query);
    ...
    if($total!=0)
    {
...

        {
           echo" <tr> 
                ...
                <td><span class='blue'>".$result['dob']."</td>
                <td>".$result['course']."</td>
                <td>".$result['gender']."</td>
...
<div class="dropdown">
 <button class="button button1">Search by</button>
  <div class="dropdown-content">
    <a href="regno.php">REGISTATION NO</a>
    <a href="name.php">NAME</a>
    <a href="course.php">COURSE</a>
  </div>
</div>
<button class="button button1" onclick="window.location.href='desc.php'">DESCENDING</button></a>
<button class="button button1" onclick="window.location.href='insert.php'">DATE TO INT</button></a>
